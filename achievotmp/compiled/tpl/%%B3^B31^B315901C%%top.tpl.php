<?php /* Smarty version 2.6.31, created on 2025-01-23 09:23:21
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary sidebar-open app-loaded"> <!--begin::App Wrapper-->
    ...
    <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
        ...
        <div class="container-fluid"> <!--begin::Start Navbar Links-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="./images/person.png" class="user-image rounded-circle shadow" alt="User Image"> <span class="d-none d-md-inline"><?php echo $this->_tpl_vars['fulluser']['name']; ?>
</span> </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                            <li class="user-header text-bg-primary"> <img src="./images/person.png"  class="rounded-circle shadow" alt="User Image">
                                <p>
                                    <?php echo $this->_tpl_vars['fulluser']['name']; ?>
                            ...
                            <li class="user-footer"> <a href="#" class="btn btn-default btn-flat">Profile</a> <a href="./index.php?atklogout=1" class="btn btn-default btn-flat float-end">Sign out</a> </li> <!--end::Menu Footer-->
                        </ul>
