<?php /* Smarty version 2.6.31, created on 2024-10-23 11:54:18
...
<div class="sidebar-brand"> <!--begin::Brand Link--> <a href="./" class="brand-link">
            <!--begin::Brand Image--> <img src="./themes/nusaatk/images/logo.png" alt="PT HARTINI PUTRA" class="brand-image opacity-75 " style="width: auto; max-height: 60px;"> <!--end::Brand Image--> <!--begin::Brand Text--> 
