...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_tag($template_tag)
    {
        ...
        switch ($tag_command) {
            ...
            case 'php':
                ...
                foreach ($this->_folded_blocks as $block) {
    ...
    function _parse_attrs($tag_args)
    {
        ...
        foreach ($tokens as $key=>$token) {
            switch ($state) {
                ...
                case 1:
                    ...
                    } else
                    {
                        // IVO && BOY HACK
                        $state = 2;
                        $nextname = $token; // The current token is actually the attr_name for the next value
            ...
            // BOY HACK
            // If we have a nextname then we should jump ahead to state 1
            if (isset($nextname) && $nextname)
            {
              $state=1;
              $attr_name = $nextname;
              unset($nextname);
        ...
        if($state != 0) {
            if($state == 1) {
               ...
               // ALMOST THE SAME IVO HACK AS ABOVE
               $attrs[0] = $attr_name;
               // END IVO HACK
            } else {
