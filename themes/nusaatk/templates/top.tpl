{atkconfig var="marquee" smartyvar="marquee"}
    ...
    <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
        ...
        <div class="container-fluid"> <!--begin::Start Navbar Links-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="./images/person.png" class="user-image rounded-circle shadow" alt="User Image"> <span class="d-none d-md-inline">{$fulluser.name}</span> </a>
